    ...
    <div className="flex flex-col h-full relative bg-transparent text-white font-sans">
      <header className="px-6 sm:px-10 pt-10 pb-6 flex flex-col gap-4 shrink-0 backdrop-blur-xl border-b border-white/5 sticky top-0 z-20">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center shadow-2xl bg-gradient-to-br from-[#8B4357] to-[#C5A059] text-black relative overflow-hidden group">
          ...
          <div>
            ...
            <p className="text-[10px] font-bold uppercase tracking-widest text-white/40 mt-0.5">Sempre aqui para te apoiar</p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-3">
          {hasUnlimitedCoach ? (
            <div className="flex items-center gap-2 px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest bg-[#C5A059]/90 border border-[#C5A059]/90 text-black">
            ...
            <div className="flex items-center gap-3 px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest bg-white/5 border border-white/10 text-white/40">
              <span>Mensagens:</span>
              <span className={`px-2 py-0.5 rounded-md font-bold ${messagesRemaining === 0 ? 'bg-[#C5A059] text-black' : 'bg-white/10 text-white'}`}>
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest bg-white/5 border border-white/10 text-white/20">
            <AlertTriangle size={12} className="text-[#C5A059]" />
      ...
      <div className="flex-1 overflow-y-auto px-6 py-10 sm:px-10 space-y-6 hide-scrollbar bg-transparent">
          ...
          >
            <div 
              className={`p-5 rounded-3xl ${
                msg.role === 'user' 
                  ? 'rounded-tr-sm text-black font-bold shadow-2xl bg-gradient-to-br from-[#8B4357] to-[#C5A059]' 
                  : 'glass-morphism rounded-tl-sm text-white/90 shadow-xl border border-white/10'
              }`}
            >
        ...
        {isLoading && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex justify-start">
            <div className="glass-morphism p-4 rounded-2xl rounded-tl-sm shadow-xl flex gap-2 items-center border border-white/10">
      ...
      <div className="px-6 py-10 sm:px-10 shrink-0 backdrop-blur-xl border-t border-white/5">
        {isBlocked ? (
          <div className="glass-morphism p-8 text-center shadow-2xl border border-white/10">
            <div className="w-14 h-14 rounded-2xl bg-[#C5A059]/90 flex items-center justify-center mx-auto mb-4">
            ...
            <button 
              onClick={onUpgrade}
              className="w-full py-5 rounded-full font-bold uppercase tracking-widest text-black shadow-2xl hover:scale-[1.02] transition-all bg-gradient-to-r from-[#8B4357] to-[#C5A059] flex items-center justify-center gap-3 text-xs"
            >
          ...
          <div className="flex items-center gap-3 glass-morphism rounded-full p-2 pr-3 focus-within:ring-2 focus-within:ring-[#C5A059]/90 transition-all shadow-2xl border border-white/10">
            <input
              type="text"
              value={input}
            ...
            <button 
              ...
              className="w-12 h-12 rounded-full flex items-center justify-center transition-all hover:scale-110 disabled:opacity-90 disabled:hover:scale-100 text-black shadow-2xl bg-gradient-to-br from-[#8B4357] to-[#C5A059]"
            >
