      ...
      <div className="space-y-8 relative z-10">
        ...
        <div className="grid grid-cols-2 gap-5">
          <button className="glass-morphism p-8 rounded-[2.5rem] border border-white/10 flex flex-col items-center justify-center gap-4 hover:border-[var(--color-primary)]/90 transition-all group shadow-2xl">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center bg-white/5 text-[var(--color-primary)] group-hover:bg-[var(--color-primary)] group-hover:text-black transition-all border border-white/10">
              <BookHeart size={28} />
            </div>
          ...
          <button className="glass-morphism p-8 rounded-[2.5rem] border border-white/10 flex flex-col items-center justify-center gap-4 hover:border-[var(--color-accent)]/90 transition-all group shadow-2xl">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center bg-white/5 text-[var(--color-accent)] group-hover:bg-[var(--color-accent)] group-hover:text-black transition-all border border-white/10">
              <Activity size={28} />
            </div>
