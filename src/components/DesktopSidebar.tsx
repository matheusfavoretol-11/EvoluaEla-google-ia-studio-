    ...
    <aside className="hidden lg:flex flex-col w-72 h-screen bg-[#141414] border-r border-white/5 sticky top-0 z-30">
      ...
      <div className="p-8 pb-10">
        <div className="flex flex-col">
          <h1 className="text-2xl font-bold tracking-tighter text-white leading-none">EvoluaEla</h1>
          <span className="text-[8px] font-bold uppercase tracking-[0.3em] text-[#E8B4BC] mt-2">High Performance</span>
        </div>
      </div>
